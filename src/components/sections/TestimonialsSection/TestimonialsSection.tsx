      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 md:px-8 pt-20 pb-14 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col items-center text-center mx-auto mb-8" style={{maxWidth:680}}>
          ...
          <motion.span
            ...
            className="inline-flex items-center gap-2 text-[10px] font-inter tracking-[0.28em] uppercase
          ...
          <motion.h2
            ...
            className="font-gondens text-[3.4rem] md:text-[4.4rem] text-[#1F2937] mb-10 leading-[1.0] w-full"
          >
            Voices of Impact
          </motion.h2>
          ...
          <motion.p
            ...
            className="font-inter text-xl md:text-[1.5rem] text-[#1F2937]/60 leading-relaxed w-full"
          >
            ...
            <React.Fragment key={label}>
              <div className="flex items-center gap-2.5">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[9px] font-inter text-zinc-400 uppercase tracking-widest mt-0.5">{label}</p>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 px-2.5 py-2 flex items-center gap-1.5"
                    ...
                    <span className="text-[8.5px] font-inter font-bold uppercase tracking-wider truncate"
                    ...
                    {hov && (
                      <motion.div
                        ...
                        className="absolute -top-10 left-1/2 -translate-x-1/2 bg-[#1F2937]
                          text-white text-[9px] font-inter font-bold px-3 py-1.5
                ...
                <div className="p-6 flex flex-col">
                  ...
                  <motion.div variants={childV} className="flex justify-center mb-4">
                    <span className="inline-flex items-center gap-2 bg-[#064e3b] text-white
                      text-[9px] font-inter font-bold tracking-[0.22em] uppercase
                  ...
                  <motion.div variants={childV}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <h3 className="font-inter text-white text-[1.75rem] font-semibold
                        leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                        {activeItem.name}
                      </h3>
                      <div className="flex items-center gap-1 mt-1.5">
                        <MapPin className="w-3 h-3 text-white/65 flex-shrink-0"/>
                        <span className="text-[9px] font-inter text-white/70 tracking-wide font-semibold">
                          {activeItem.location}
                        </span>
                      </div>
                    </div>
                  ...
                  <motion.div variants={childV}
                    ...
                    <span className="inline-flex items-center gap-1.5 text-[9px] font-inter
                  ...
                  <motion.div variants={childV} className="grid grid-cols-2 gap-3">
                    <div className="bg-[#f8fdf8] rounded-2xl px-4 py-3 border border-[#e8f5e9]
                      ...
                      <p className="text-[7.5px] font-inter uppercase tracking-[0.22em]
              ...
              <div className="p-5 flex flex-col">
                <div className="flex justify-center mb-4">
                  <span className="inline-flex items-center gap-1.5 bg-[#064e3b] text-white
                    text-[8px] font-inter font-bold tracking-widest uppercase
                ...
                <div className="relative w-full rounded-[18px] overflow-hidden"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <h3 className="font-inter text-white text-xl font-semibold drop-shadow-lg">
                      {activeItem.name}
                    </h3>
                    <div className="flex items-center gap-1 mt-1">
                      <MapPin className="w-2.5 h-2.5 text-white/65"/>
                      <span className="text-[8px] font-inter text-white/70">{activeItem.location}</span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-between mt-3">
                  <span className="inline-flex items-center gap-1.5 text-[8px] font-inter
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="bg-[#f8fdf8] rounded-xl px-3 py-2.5 border border-[#e8f5e9]">
                    <p className="text-[7px] font-inter uppercase tracking-widest text-zinc-400 font-bold mb-0.5">
                      Initiative</p>
        ...
        <div className="mt-10 md:mt-12 flex items-center justify-center gap-5 z-20">
          ...
          <div className="flex flex-col items-center gap-2">
            <span className="text-[10px] font-inter text-zinc-400 font-bold tracking-[0.2em]">
            ...
            <div className="flex gap-1.5 items-center">
              {testimonials.map(t=>(
                <button
                  ...
                  aria-current={activeItem.id===t.id ? "true" : undefined}
